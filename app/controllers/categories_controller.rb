class CategoriesController < ApplicationController
    ...
    def index
        ...
        pending_tasks = category.tasks.where(date: Date.today, completed: false).count
...
# Additional user story: As a user, I want to delete a category to better organize my tasks
    def destroy
        @category.destroy
        redirect_to root_path, notice: "Category #{@category.id} successfully destroyed.", status: :see_other
    end
